...
const defaultExpertiseBlocks: ExpertiseBlock[] = [
  {
    id: "notion",
    icon: "FileText",
    title_ru: "Рабочие пространства Notion",
  ...
  },
  {
    id: "ai",
    icon: "Bot",
    title_ru: "Автоматизации и AI",
    title_en: "Automations & AI",
    description_ru: "Создаю AI-решения и автоматизации на базе n8n, Zapier, Make. Настраиваю воркфлоу для связки CRM, мессенджеров и AI-агентов.",
    description_en: "Building AI solutions and automations using n8n, Zapier, Make. Setting up workflows connecting CRM, messengers, and AI agents.",
    highlights_ru: ["n8n", "Zapier", "Make", "AI агенты", "Интеграции"],
    highlights_en: ["n8n", "Zapier", "Make", "AI Agents", "Integrations"],
    link: "/cases",
  },
  {
    id: "vibe-coding",
