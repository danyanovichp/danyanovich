...
const techStack = [
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 100 100" fill="currentColor" className="w-10 h-10">
        <path d="M50 10 C30 10 25 20 25 30 L25 40 L50 40 L50 45 L20 45 C10 45 5 55 5 65 C5 75 15 85 25 85 L35 85 L35 70 C35 60 45 55 50 55 L70 55 C80 55 85 50 85 40 L85 30 C85 20 75 10 50 10 Z M35 25 C38 25 40 27 40 30 C40 33 38 35 35 35 C32 35 30 33 30 30 C30 27 32 25 35 25 Z" />
        <path d="M50 90 C70 90 75 80 75 70 L75 60 L50 60 L50 55 L80 55 C90 55 95 45 95 35 C95 25 85 15 75 15 L65 15 L65 30 C65 40 55 45 50 45 L30 45 C20 45 15 50 15 60 L15 70 C15 80 25 90 50 90 Z M65 75 C62 75 60 73 60 70 C60 67 62 65 65 65 C68 65 70 67 70 70 C70 73 68 75 65 75 Z" />
      </svg>
    ),
  },
];
