    ...
    translation: {
      ...
      home: {
        hero: {
          ...
          description: 'Создаю рабочие пространства для компаний, готовых заменить хаос в таблицах на централизованную операционную систему на основе Notion, Buildin.AI',
    ...
    translation: {
      ...
      home: {
        hero: {
          ...
          description: 'I create workspaces for companies ready to replace spreadsheet chaos with a centralized operating system based on Notion, Buildin.AI',
