...
const Terms = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <section className="py-16 md:py-20 bg-pastel-yellow border-b-2 border-foreground flex-1">
        <div className="container">
          <div className="max-w-3xl mx-auto prose dark:prose-invert bg-card border-4 border-foreground shadow-[12px_12px_0px_0px_currentColor] p-8 md:p-12 mb-12">
            <h1 className="font-display uppercase tracking-wider">{isRu ? 'Пользовательское соглашение' : 'Terms of Service'}</h1>
